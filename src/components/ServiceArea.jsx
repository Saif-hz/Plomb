        ...
        <div className="grid gap-8 rounded-3xl border border-brand-100 bg-gradient-to-br from-white via-brand-50/30 to-orange-50/40 p-8 sm:p-10 lg:grid-cols-[1.1fr_1fr]">
          <div>
            ...
            <p className="section-subtitle">
              Intervention rapide sur Lyon et sa proche couronne. Un doute sur votre secteur?
              Appelez-nous et nous confirmons immediatement.
            </p>
          ...
          >
            ...
            <h3 className="mt-4 font-heading text-2xl">Hub intervention Lyon centre</h3>
            <p className="mt-2 text-sm text-white/85">18 Rue de la République, 69002 Lyon</p>
            <p className="mt-6 text-sm text-white/85">
              Cette implantation nous permet de reduire les delais d'arrivee et de couvrir les
              urgences sur toute la metropole.
            </p>
            <div className="mt-6 grid grid-cols-3 gap-2 text-center text-xs">
              <div className="rounded-lg bg-white/10 p-2">20 min</div>
              <div className="rounded-lg bg-white/10 p-2">35 min</div>
              <div className="rounded-lg bg-white/10 p-2">45 min</div>
            </div>
          </motion.div>
        </div>
      </div>
